...
mydat = read.csv2("D:/Home/ocbegassat/Documents/Oceane_BEGASSAT/Thesis_guifette/ENS/CPES 2 projet/0041794-241126133413365.csv", sep = '\t')
...
plot(alouette) #représente toutes les observations de l'alouette en France, selon leurs coordonnées
